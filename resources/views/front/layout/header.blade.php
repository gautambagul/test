...
<div class="alert alert-warning alert-dismissible fade show home-alert" role="alert">
  <a href="{{ optional($bannersetting)['url'] }}" target= _blank title=""><img src="{{url('images/banner/'.$bannersetting->image)}}" class="w-100 mw-100 h-50px h-lg-auto img-fit"></a>
                ...
                <div class="display-none-block">
                    <ul class="list-unstyled">
                        ...
                        <li class="first"><a title="{{ __('staticwords.SellerDashboard') }}"
                            href="{{ route('backlogin.as', Session::get('admin_id')) }}" title="Admin">{{ __('Return Admin') }}</a>
                        </li>
                        @endif
